        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://upload.imagekit.io https://ik.imagekit.io https://*.clerk.accounts.dev https://clerk.dev https://api.clerk.dev https://api.clerk.com wss://*.clerk.accounts.dev",
