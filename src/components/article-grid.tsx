                ...
                {article.articuloCategorias &&
                  article.articuloCategorias.length > 0 && (
                    ...
                    >
                      <Badge
                        variant="secondary"
                        className="mb-3 cursor-pointer hover:bg-secondary/80 transition-colors"
                      >
                        {article.articuloCategorias[0].categoria.nombre}
                      </Badge>
                    </Link>
                  )}
                <h3 className="text-xl font-serif font-bold mb-2 line-clamp-2 group-hover:text-primary transition-colors">
                  {article.titulo}
                </h3>
                {article.descripcion && (
